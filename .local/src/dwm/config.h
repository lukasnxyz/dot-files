...
static const char *cmdbacklightup[]  = { "brightnessctl", "set", "+5%", NULL };
static const char *cmdbacklightdown[]  = { "brightnessctl", "set", "5%-", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
    { MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
    { MODKEY,                  XK_Return,      spawn,          SHCMD("$TERMINAL +new-window") },
    { MODKEY,                       XK_w,      spawn,          SHCMD("$BROWSER") },
    { MODKEY,                       XK_a,      spawn,          SHCMD("$TERMINAL -e pulsemixer +new-window") },
    ...
    { MODKEY,                       XK_c,      spawn,          SHCMD("toggle_theme.sh") },
    { MODKEY|ShiftMask,             XK_c,      spawn,          SHCMD("toggle_grayscale.sh") },
